...
- [NewsRadar 排程把 ollama 鎖在 .161 GPU 上](solis-news-aggregator-ollama-conflict.md) — 持續呼叫 ollama 的元凶是 NewsRadar 的 WP-Cron,不是 WorkflowUI;修法是 OllamaAnalyzer.php 帶 keep_alive:0
